    ...
    if ($App_Folder_Main -like "*Trusted*")
        {
            ...
            ($EdgeAuto.FindElements([OpenQA.Selenium.By]::TagName("button")) | where-Object ComputedAccessibleLabel -Like "*Trusted*Agent*" | Where-Object ComputedAccessibleLabel -notlike "*s*ript*").click()
        ...
        if ($App_Folder_Main -like "*Trusted*")
            {
                ...
                ($EdgeAuto.FindElements([OpenQA.Selenium.By]::Classname("btn-download-lg"))| Where-Object ComputedAccessibleLabel -like "Trusted*" ).click()
