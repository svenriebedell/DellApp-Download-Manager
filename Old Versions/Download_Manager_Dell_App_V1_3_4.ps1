            ...
            if ($App_Folder_Main -like "*Trusted*")
                {
                    ...
                    ($EdgeAuto.FindElements([OpenQA.Selenium.By]::Classname("btn-download-lg"))| Where-Object ComputedAccessibleLabel -like "*Trusted*Agent*" | Where-Object ComputedAccessibleLabel -notlike "*Trusted Device Agent Scripts*").click()
